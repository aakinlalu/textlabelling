...
from sqlalchemy import create_engine, MetaData, inspect, Table, Column, Integer, DATETIME
        ...
        try:
            ...
            if table_name not in inspector.get_table_names():
                ...
                table = Table(table_name, metadata,
                     ...
                     Column('reference_ticket', String),
                     Column('nps_score', String),
                     Column('feature_intents', String),
                     Column('feature_category', String))
